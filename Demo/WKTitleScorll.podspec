#
#  Be sure to run `pod spec lint WKTitleScorll.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = '1.0.3'
  s.summary      = "主要适用于一个主控制器下面有多个子控制器"
...
s.source           = { :git => "https://github.com/wyxlh/WKTitleScorll.git", :tag => "v#{s.version}" }
